...
export default function LoginPage() {
  ...
  return (
    <div style={{background: bg, color: text, minHeight: '100vh'}}>
      ...
      {/* 1. STICKY HEADER SETTING ANG CHIAH */}
      <div style={{
        background: card,
        padding: '16px',
        display: 'flex',
        ...
        <h1 style={{fontSize: '22px', fontWeight: '800', margin: 0}}>Login</h1>
      </div>
          ...
          <div style={{background: card, padding: '24px', borderRadius: '20px', border: `1px solid ${border}`, boxShadow: '0 8px 30px rgba(0,0,0,0.12)'}}>
            ...
            <div style={{display: 'flex', flexDirection: 'column', gap: '14px'}}>
              ...
              <div style={{position: 'relative'}}>
                ...
                />
                {/* 3. EYE ICON Z-INDEX BELH */}
                <button onClick={()=>setShowPass(!showPass)} style={{position: 'absolute', right: '16px', top: '50%', transform: 'translateY(-50%)', background: 'none', border: 'none', padding: 0, cursor: 'pointer', zIndex: 2}}>
                  {showPass? (
